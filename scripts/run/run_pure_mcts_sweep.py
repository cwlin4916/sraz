...
Usage:
    python scripts/run/run_pure_mcts_sweep.py
    python scripts/run/run_pure_mcts_sweep.py --n-episodes 15 --out /tmp/probe.json
"""
...
def main():
    ...
    out = {
        "_provenance": {
            ...
            "reproduce": "python scripts/run/run_pure_mcts_sweep.py",
        },
        "hyperparameters": {
